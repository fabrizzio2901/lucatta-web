      ...
      <main>
        <section className="hero" id="inicio">
          <div className="hero-copy">
            ...
            <p className="hero-intro">
              Creamos pasteles y postres personalizados para acompañar tus momentos más especiales. Muy
              pronto también podrás disfrutar café, pan y postres en nuestro espacio de Casa Blanca.
            </p>
            <div className="hero-actions">
              ...
              <a className="text-link" href="#local">
                {siteStatus.localOpen ? 'Visítanos' : 'Conoce nuestro próximo local'}
          ...
          <figure className="hero-image-wrap">
            ...
            />
            <figcaption>Celebraciones hechas a tu medida</figcaption>
          </figure>
        </section>

        <section className="promise-strip" aria-label="Características de Lucátta">
        ...
        <section className="section-shell creations-section" id="creaciones">
          <div className="section-heading split-heading">
            ...
            <p>
              Pasteles personalizados, galletas, cupcakes, fresas decoradas y otros postres preparados
          ...
          <div className="gallery-note">
            <p>
              Estas imágenes son ejemplos de trabajos por encargo. Cada detalle se acuerda contigo y una
              referencia no garantiza una réplica exacta. La selección disponible en el futuro local
              podrá variar.
            </p>
            <a className="button" href={WHATSAPP_URL} target="_blank" rel="noreferrer">
              Pedir información
        ...
        <section className="order-section" id="como-pedir">
          <div className="section-shell">
            <div className="section-heading centered-heading">
              ...
              <p>La conversación y la cotización se realizan personalmente por WhatsApp.</p>
            </div>
            ...
            <div className="order-clarification">
              <p>
                Enviar una solicitud no reserva la fecha. La confirmación requiere completar las
                características del pedido y verificar el anticipo.
              </p>
              <div>
                <a className="inline-link inline-link-light" href="/condiciones-de-pedidos">
                  Consultar condiciones de pedidos <ArrowRight aria-hidden="true" />
                </a>
                <a className="button button-cream" href={WHATSAPP_URL} target="_blank" rel="noreferrer">
                  Pedir información
                </a>
              </div>
            </div>
        ...
        <section className="section-shell events-section" id="eventos">
          <div className="events-card">
            ...
            <div className="events-copy">
              ...
              <p>
                Cuéntanos sobre tu fecha, número de asistentes, tipo de evento y zona. Podemos conversar
                sobre mesas de postres, catering y coffee breaks según tus necesidades.
              </p>
            </div>
            <a
              className="button button-outline"
              href={siteStatus.eventsPageReady ? '/eventos' : WHATSAPP_URL}
              target={siteStatus.eventsPageReady ? undefined : '_blank'}
              rel={siteStatus.eventsPageReady ? undefined : 'noreferrer'}
            >
              {siteStatus.eventsPageReady ? 'Ver servicios para eventos' : 'Pedir información'}
            </a>
          </div>
        </section>
        ...
        <section className="local-section" id="local">
          ...
          <div className="local-copy">
            ...
            <div className="local-detail">
              ...
              <div>
                <span>{siteStatus.localOpen ? 'Dirección' : 'Ubicación del próximo local'}</span>
            ...
            <div className="local-detail">
              ...
              <div>
                <span>{siteStatus.localOpen ? 'Horario' : 'Horario previsto'}</span>
                <p>{siteStatus.localHours}</p>
              </div>
            </div>
            {siteStatus.localOpen ? (
              <a className="button button-cream" href={MAPS_SEARCH_URL} target="_blank" rel="noreferrer">
                Cómo llegar
              </a>
            ) : (
              <p className="local-note">
                La fecha de apertura aún no está confirmada. Por ahora, la recolección se coordina por
                WhatsApp.
              </p>
            )}
          </div>
        ...
        <section className="section-shell story-section" id="historia">
          ...
          <div className="story-copy">
            ...
            <div className="story-text">
              <p>
                Después de terminar la universidad, nuestra fundadora comenzó vendiendo postres a
                familiares y amigos. Esa primera comunidad fue el inicio de todo.
              </p>
              <p>
                Más adelante cursó una maestría especializada en repostería. El proyecto nació como
                Baking Time y después tomó el nombre Lucátta, inspirado en los nombres de sus hijos.
              </p>
              <p>
                Hoy seguimos creando de forma artesanal, cuidando cada detalle y escuchando la historia
        ...
        <section className="section-shell faq-section" id="preguntas">
          <div className="faq-intro">
            ...
            <p>Si tu duda no aparece aquí, escríbenos y te ayudamos personalmente.</p>
        ...
        <section className="closing-section">
          ...
          <p>Escríbenos y te ayudamos a preparar algo especial para tu celebración.</p>
          <a className="button button-cream" href={WHATSAPP_URL} target="_blank" rel="noreferrer">
            Pedir información
          </a>
        </section>
